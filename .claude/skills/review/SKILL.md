...
5. **DB migrations**: if `prisma/schema.prisma` changed, verify the matching SQL exists in `scripts/sql/YYYY-MM-DD-*.sql`. If not, flag as blocker — see CLAUDE.md "Database Notes" for why.
